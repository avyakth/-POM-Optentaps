...
public class Jenkins_eventlogger {
	public enum logType
	 {
	...
	static DateFormat rptTme = new SimpleDateFormat("EEEE yyyy:MM:dd hh:mm:ss a");
	static Calendar cal = Calendar.getInstance();
	static String reprtTime = rptTme.format(cal.getTime());
	public static void baselog() throws IOException {
		DateFormat dateFormat = new SimpleDateFormat("yyyy_MM_dd");		
		String cal1 = dateFormat.format(cal.getTime());
		String ExecLogger = "src/CXM ExecLog "+cal1+".html";	
		File resDir = new File("src/");
	...
	public static void func_log() throws IOException {
		DateFormat dateFormat = new SimpleDateFormat("yyyy_MM_dd");		
		String cal1 = dateFormat.format(cal.getTime());
		String ExecLogger = "src/CXM ExecLog "+cal1+".html";	
		FileWriter FW = new FileWriter(ExecLogger,true); 
		...
		BW.write("Functionality : "+CXM_Jenkins2.crntSheet);
		BW.write("</B></font></TD></tr></TBODY></TABLE>");
		BW.write("<br><font color = black size=2>--> [");
		BW.write(reprtTime);
		BW.write("] [INFO] - ");
		BW.write("<<<< "+CXM_Jenkins2.crntSheet+" Functionality");
	...
	public static void log(String logLevel,String msg) throws IOException {
		...
		case config:
			...
			break;
		case validation:
			if (CXM_Jenkins2.Teststatus.equals("PASS")){
				color = "blue";
