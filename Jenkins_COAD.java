...
public class Jenkins_COAD {
	...
	public void setUp(String hubUrl, String datasheetPath, String Sheet_Name, String selectedApp, String baseUrl, String mail_app, String errorSheet) throws Exception
	{
        ...
        if(baseUrl.contains("http"))
        {
        	 if(AppConfig.get("BrowserName").toString().toUpperCase().contentEquals("FIREFOX"))
        		...
        		/* File file = new File("C:\\Selenium\\library\\IEDriverServer_Win32_2.41.0\\IEDriverServer.exe");
        ...
        if(baseUrl.contains("http"))
        {
 	        	...
 	        	driver.get((String) AppConfig.get("App_URL"));
 	        	System.out.println((String) AppConfig.get("App_URL")+" Launched");
 	   	}
	...
	public void testActionSimulator(String Sheet_Name, String datasheetPath, String selectedApp, String baseUrl, String mail_app, String hubUrl, String errorSheet) throws BiffException, IOException, RowsExceededException, WriteException {
		try{
			if(baseUrl.contains("http"))
				driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
			System.out.println("datasheetPath "+datasheetPath);
			File  fis = new File(datasheetPath);
			Workbook wb = Workbook.getWorkbook(fis);
		    Sheet s = wb.getSheet("AppConfig");
		    Hashtable AppConfig = new Hashtable();
		  ...
		  {
			  try{
			  fnSimulator(errorSheet, baseUrl, selectedApp, "Node0",Sheet_Name, s3.getCell(0,i).getContents(),s3.getCell(1,i).getContents(),s3.getCell(2,i).getContents(),s3.getCell(3,i).getContents(), s3.getCell(4,i).getContents(), s3.getCell(5,i).getContents(), s3.getCell(6,i).getContents(), s3.getCell(7,i).getContents(), s3.getCell(8,i).getContents(), s3.getCell(9,i).getContents(), s3.getCell(10,i).getContents(),s3.getCell(11,i).getContents());
			  }catch(Exception e)
			  {
				  System.out.println(e.getMessage());
			  }
	...
	public void fnSimulator(String errorSheet, String App_URL, String selectedApp, String Node_Name, String SheetName, String Step_No, String TC_Name, String Element_Name, String Element_Property, String Element_Property_Value, String Action, String Element_Input_Value, String ChkElement_Property, String ChkElement_Property_Value, String Report, String ActionIfNotFound, String ErrorType) throws IOException, AWTException, InterruptedException, BiffException, RowsExceededException, WriteException
	  {
		  ...
		  case "SOAP":
					...
					URL URL = new URL(Element_Property_Value);
					...
					status = "info";
	  				Teststatus = "PASS";
	  				stepinfo = SheetName+" SOAP Response is received. Plan PK ID # "+store.get("PK");
	  				System.out.println(stepinfo);
			break;
		    case "SOAP_VERIFY":
		    	 System.out.println("SOAP_VERIFY");
		    	String soap_res = (String) store.get("Response");
  		...
  		break;
		  	...
		  	break;
		  	case "WAIT":
		  		long wait = Integer.parseInt(Element_Input_Value)*1000;
		  		status = "info";
		  		Teststatus = "PASS";
		  		Thread.sleep(wait);
		  		ErrDesc = stepinfo;
	  ...
	  public void report(String selectedApp, String SheetName, String TestCaseName, String TestStep) throws IOException, RowsExceededException, WriteException, BiffException{
			...
			String cal1 = dateFormat.format(cal.getTime());
			String filepath = "C:\\Selenium\\Results\\"+selectedApp+" Detailed Report "+cal1+".xls";
			File ifilepath = new File("C:\\Selenium\\Results\\"+selectedApp+" Detailed Report "+cal1+".xls");
			String ofilepath = "C:\\Selenium\\Results\\"+selectedApp+" Detailed Report "+cal1+"_temp.xls";
